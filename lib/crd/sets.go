          ...
          spec:
            properties:
              ...
              clusterSelector:
                ...
                type: string
              maxReplicas:
                description: MaxReplicas specifies the maximum number of clusters
                  to be selected from the pool matching the clusterSelector.
                type: integer
            type: object
          status:
            ...
            properties:
              matchingClusterRefs:
                description: MatchingClusterRefs reference all the clusters currently
                  matching ClusterSet/Set ClusterSelector
                items:
                  description: "ObjectReference contains enough information to let
                    you inspect or modify the referred object. --- New uses of this
                    type are discouraged because of difficulty describing its usage
                ...
                type: array
              selectedClusterRefs:
                description: SelectedClusters reference all the cluster currently
                  selected among all the ones matching
                items:
                  description: "ObjectReference contains enough information to let
                    you inspect or modify the referred object. --- New uses of this
                    type are discouraged because of difficulty describing its usage
