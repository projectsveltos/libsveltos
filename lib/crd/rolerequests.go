      ...
      openAPIV3Schema:
        ...
        properties:
          ...
          status:
            ...
            properties:
              clusterHashes:
                description: ClusterHash represents the hash of the ClusterRoles/Roles
                ...
                items:
                  properties:
                    clusterName:
                      ...
                      type: string
                    clusterNamespace:
                      description: ClusterNamespace is the namespace of the managed
                        Cluster
                      type: string
                    clusterType:
                      ...
                      type: string
                    hash:
                      description: Hash is the hash of the ClusterRoles/Roles deployed
                        in the managed cluster for admin
                      format: byte
                      type: string
                  required:
                  - clusterName
