            ...
            properties:
              aggregatedAnalysis:
                description: 'This field is optional and can be used to specify a
                  Lua function that will be used to further analyze a subset of the
                  ...
                  field allows to perform more complex analysys  on the resources,
                  looking at all resources together. This can be useful for more sophisticated
                  tasks, such as identifying resources that are related to each other
                  or that have similar properties. The Lua function must return a
                  struct with: - "resources" field: slice of resorces; - "message"
