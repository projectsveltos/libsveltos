...
var ManagementClusterClassifierReportFile = "../../manifests/apiextensions.k8s.io_v1_customresourcedefinition_managementclusterclassifierreports.lib.projectsveltos.io.yaml"
var ManagementClusterClassifierReportCRD = []byte(`apiVersion: apiextensions.k8s.io/v1
...
spec:
  ...
  names:
    kind: ManagementClusterClassifierReport
    listKind: ManagementClusterClassifierReportList
    plural: managementclusterclassifierreports
    singular: managementclusterclassifierreport
  scope: Namespaced
  versions:
  - name: v1beta1
    schema:
      openAPIV3Schema:
        ...
        properties:
          ...
          spec:
            ...
            properties:
              classifierName:
                description: ClassifierName is the name of the ManagementClusterClassifier
                  this report is for.
                type: string
              clusterName:
                description: ClusterName is the name of the cluster this report is
                  for.
                type: string
              clusterNamespace:
                ...
                type: string
              clusterType:
                description: ClusterType is the type of the cluster this report is
                  for.
                type: string
            required:
            - classifierName
            ...
            type: object
          status:
            description: ManagementClusterClassifierReportStatus is written by the
              controller after processing.
            properties:
              managedLabels:
                description: |-
