...
var ManagementClusterClassifierFile = "../../manifests/apiextensions.k8s.io_v1_customresourcedefinition_managementclusterclassifiers.lib.projectsveltos.io.yaml"
var ManagementClusterClassifierCRD = []byte(`apiVersion: apiextensions.k8s.io/v1
...
spec:
  ...
  names:
    ...
    listKind: ManagementClusterClassifierList
    plural: managementclusterclassifiers
    singular: managementclusterclassifier
  scope: Cluster
  versions:
  - name: v1beta1
    schema:
      openAPIV3Schema:
        ...
        properties:
          ...
          metadata:
            type: object
          spec:
            description: ManagementClusterClassifierSpec defines the desired state
              of ManagementClusterClassifier.
            properties:
              classificationLua:
                description: |-
            ...
            type: object
          status:
            description: ManagementClusterClassifierStatus defines the observed state
              of ManagementClusterClassifier.
            properties:
              failureMessage:
                description: |-
