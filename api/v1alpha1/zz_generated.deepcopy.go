...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterHash) DeepCopyInto(out *ClusterHash) {
	*out = *in
	if in.Hash != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterHash.
func (in *ClusterHash) DeepCopy() *ClusterHash {
	if in == nil {
		return nil
	}
	out := new(ClusterHash)
...
func (in *RoleRequestStatus) DeepCopyInto(out *RoleRequestStatus) {
	*out = *in
	...
	if in.ClusterHashes != nil {
		in, out := &in.ClusterHashes, &out.ClusterHashes
		*out = make([]ClusterHash, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
