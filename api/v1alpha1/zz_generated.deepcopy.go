...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IgnoreDriftItem) DeepCopyInto(out *IgnoreDriftItem) {
	*out = *in
	if in.Paths != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IgnoreDriftItem.
func (in *IgnoreDriftItem) DeepCopy() *IgnoreDriftItem {
	if in == nil {
		return nil
	}
	out := new(IgnoreDriftItem)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceSummarySpec) DeepCopyInto(out *ResourceSummarySpec) {
	*out = *in
	...
	if in.IgnoreDrift != nil {
		...
		*out = make([]IgnoreDriftItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
